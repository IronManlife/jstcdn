...
var post = {
    ...
    tocEleRight: function () {
        ...
        tocEle && (tocEle.style.left = (screenWidth - 800) / 2 + 900 + "px")
    },
    ...
    expandCode: function () {
        $(".code-toolbar").dblclick((function () {
            $(this).hasClass("code-block-fullscreen") ? ($(this).removeClass("code-block-fullscreen"), $("html").removeClass("code-block-fullscreen-html-scroll")) : ($(this).addClass("code-block-fullscreen"), $("html").addClass("code-block-fullscreen-html-scroll"))
        })), $(document).keyup((function (e) {
            var key;
            27 == (e.which || e.keyCode) && $(".code-toolbar").hasClass("code-block-fullscreen") && ($(".code-toolbar").removeClass("code-block-fullscreen"), $("html").removeClass("code-block-fullscreen-html-scroll"))
        }))
    }
};
$(function () {
