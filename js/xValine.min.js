...
! function (e, t) {
	...
	return function (e) {
		...
		"use strict";
		t.__esModule = !0;
		t.DEFAULT_EMOJI_CDN = "https://cdn.jsdelivr.net/gh/betsyx/jstcdn/expression/", t.DB_NAME = "Comment", t.defaultConfig = {
			lang: "zh-CN",
			langMode: null,
			appId: "",
			appKey: "",
			...
			placeholder: "感谢相遇，欢迎于此地分享你的想法  (填写邮箱能方便收到回复噢)",
			pageSize: 10,
			recordIP: !0,
			serverURLs: "",
			visitor: !1,
		...
		o.prototype.Q = function (e) {
			...
			var C = function (t, n, r) {
					...
					var l = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
						...
						d = u + '<div class="vh"><div class="vhead">' + c + " " + a + '</div><div class="vmeta"><span class="vtime" >' + vdate(t.get("insertedAt")) + '</span><span class="vat" data-vm-id="' + (t.get("rid") || t.id) + '" data-self-id="' + t.id + '">' + e.i18n.t("reply") + '</span></div><div class="vcontent" data-expand="' + e.i18n.t("expand") + '">' + (0, S.default)(t.get("comment")) + '</div><div class="vreply-wrapper" data-self-id="' + t.id + '"></div><div class="vquote" data-self-id="' + t.id + '"></div></div>';
					o.html(d);
					var p = o.find(".vat");
		...
		*/
        ...
        function n(e) {
            return "bilibili/bili_%20" + e + ".webp"
        }
        ...
        e.exports = {
            ...
            "停不下来": "https://cdn.jsdelivr.net/gh/drew233/cdn/zqq.webp",
			...
			"转圈圈": "https://cdn.jsdelivr.net/gh/drew233/cdn/20200409130301.webp",
			...
			"耍酷": "https://cdn.jsdelivr.net/gh/betsyx/jstcdn/img/cool.gif",
			"我也要":"https://cdn.jsdelivr.net/gh/betsyx/jstcdn/expression/customize/22.webp"
        };
